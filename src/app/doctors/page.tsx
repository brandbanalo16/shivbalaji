                    ...
                    <div className="auto-container">
                        <div className="row clearfix">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-12 team-block">
                                <div className="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <div className="inner-box">
                                        <figure className="image-box"><Link href="/doctor-details"><Image src="/assets/images/team/team-4.jpg" alt="Image" width={416} height={430} priority /></Link></figure>
                                        <div className="content-box">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-12 team-block">
                                <div className="team-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                    <div className="inner-box">
                                        <figure className="image-box"><Link href="/doctor-details"><Image src="/assets/images/team/team-5.jpg" alt="Image" width={416} height={430} priority /></Link></figure>
                                        <div className="content-box">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-12 team-block">
                                <div className="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                    <div className="inner-box">
                                        <figure className="image-box"><Link href="/doctor-details"><Image src="/assets/images/team/team-6.jpg" alt="Image" width={416} height={430} priority /></Link></figure>
                                        <div className="content-box">
                                            ...
                                            <div className="pricing-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                                <div className="pricing-table">
                                                    ...
                                                    <div className="table-content">
                                                        <div className="btn-box"><Link href="/pricing" className="theme-btn btn-one">Choose Plan +</Link></div>
