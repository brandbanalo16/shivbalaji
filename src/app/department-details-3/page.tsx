                            ...
                            <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                                <div className="service-sidebar">
                                    <div className="sidebar-widget category-widget mb_40">
                                        ...
                                        <div className="widget-content">
                                            <ul className="category-list clearfix">
                                                ...
                                                <li><Link href="/department-details-3" className="current">Gastroenterology</Link></li>
                                    ...
                                    <div className="sidebar-widget appointment-widget mb_40">
                                        ...
                                        <AppointmentSidebarForm formName="Department Details Appointment - Gastroenterology" />
                                    </div>
                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                                <div className="service-details-content">
                                    <div className="content-one mb_40">
                                        <figure className="image-box mb_60"><Image src="/assets/images/service/service-7.jpg" alt="Image" width={856} height={525} priority /></figure>
