module.exports=[91542,a=>{"use strict";a.s(["default",()=>e]);var b=a.i(87924),c=a.i(72131),d=a.i(71133);function e({images:a,productName:e}){let[f,g]=(0,c.useState)(0),[h,i]=(0,c.useState)({}),[j,k]=(0,c.useState)(!1),l=(0,c.useRef)(null),m=a[f]||a[0];return(0,b.jsxs)("div",{className:"product-image-gallery layout-side",children:[(0,b.jsx)("style",{children:`
      ...
      `}})]})}},73885,a=>{"use strict";a.s(["default",()=>e]);var b=a.i(87924),c=a.i(72131),d=a.i(11570);function e({productName:a}){let[e,f]=(0,c.useState)(!1),[g,h]=(0,c.useState)(null),i=async b=>{b.preventDefault(),f(!0),h(null);let c=new FormData(b.currentTarget),e={formName:"Product Enquiry",name:c.get("name"),email:c.get("email"),phone:c.get("phone"),message:c.get("message"),product:a},g=await (0,d.submitEnquiry)(e);h({type:g.success?"success":"error",text:g.message}),g.success&&b.currentTarget.reset(),f(!1)};return(0,b.jsxs)("form",{onSubmit:i,children:[g&&(0,b.jsx)("div",{style:{padding:"15px",marginBottom:"20px",borderRadius:"6px",background:"success"===g.type?"#dcfce7":"#fee2e2",color:"success"===g.type?"#166534":"#991b1b",fontSize:"14px"},children:g.text}),(0,b.jsxs)("div",{className:"form-group mb-3",children:[(0,b.jsx)("label",{style:{fontSize:"14px",fontWeight:600,color:"#475569",marginBottom:"8px",display:"block"},children:"Full Name *"}),(0,b.jsx)("input",{type:"text",name:"name",required:!0,style:{width:"100%",padding:"14px 20px",border:"1px solid #cbd5e1",borderRadius:"6px",fontSize:"15px",background:"#f8fafc"},placeholder:"Enter your name",disabled:e})]}),(0,b.jsxs)("div",{className:"row mb-3",children:[(0,b.jsxs)("div",{className:"col-md-6 form-group mb-3 mb-md-0",children:[(0,b.jsx)("label",{style:{fontSize:"14px",fontWeight:600,color:"#475569",marginBottom:"8px",display:"block"},children:"Email Address *"}),(0,b.jsx)("input",{type:"email",name:"email",required:!0,style:{width:"100%",padding:"14px 20px",border:"1px solid #cbd5e1",borderRadius:"6px",fontSize:"15px",background:"#f8fafc"},placeholder:"Enter your email",disabled:e})]}),(0,b.jsxs)("div",{className:"col-md-6 form-group",children:[(0,b.jsx)("label",{style:{fontSize:"14px",fontWeight:600,color:"#475569",marginBottom:"8px",display:"block"},children:"Phone Number *"}),(0,b.jsx)("input",{type:"text",name:"phone",required:!0,style:{width:"100%",padding:"14px 20px",border:"1px solid #cbd5e1",borderRadius:"6px",fontSize:"15px",background:"#f8fafc"},placeholder:"Enter your phone",disabled:e})]})]}),(0,b.jsxs)("div",{className:"form-group mb-4",children:[(0,b.jsx)("label",{style:{fontSize:"14px",fontWeight:600,color:"#475569",marginBottom:"8px",display:"block"},children:"Message"}),(0,b.jsx)("textarea",{name:"message",rows:4,style:{width:"100%",padding:"14px 20px",border:"1px solid #cbd5e1",borderRadius:"6px",fontSize:"15px",resize:"none",background:"#f8fafc"},placeholder:`I am interested in ${a}...`,disabled:e})]}),(0,b.jsx)("button",{type:"submit",disabled:e,className:"theme-btn btn-one",style:{width:"100%",border:"none",padding:"15px",borderRadius:"6px",opacity:e?.7:1},children:(0,b.jsxs)("span",{style:{padding:"0"},children:[e?"Submitting...":"Submit Enquiry"," ",(0,b.jsx)("i",{className:"fa-solid fa-arrow-right ms-2"})]})})]})}},16762,a=>{"use strict";a.s(["default",()=>g]);var b=a.i(87924),c=a.i(71133),d=a.i(38246);a.i(9068);var e=a.i(84850),f=a.i(91858);function g({relatedProducts:a,categorySlug:g}){return(0,b.jsx)(f.Swiper,{modules:[e.Autoplay],spaceBetween:30,loop:!0,speed:1500,autoplay:{delay:3e3,disableOnInteraction:!1},breakpoints:{0:{slidesPerView:1},576:{slidesPerView:2},992:{slidesPerView:3},1200:{slidesPerView:4}},children:a.map(a=>(0,b.jsx)(f.SwiperSlide,{style:{height:"auto"},children:(0,b.jsxs)("div",{className:"product-card-clean",style:{background:"#fff",borderRadius:"8px",border:"1px solid #eaeaea",overflow:"hidden",transition:"transform 0.3s ease, box-shadow 0.3s ease",width:"100%",display:"flex",flexDirection:"column",height:"100%"},children:[(0,b.jsx)("figure",{className:"image-box",style:{position:"relative",padding:"0",background:"#eef5ff",textAlign:"center",margin:0,aspectRatio:"1 / 1",overflow:"hidden",flexShrink:0},children:(0,b.jsx)(d.default,{href:`/${g}/${a.subcategory}/${a.slug}`,style:{display:"block",width:"100%",height:"100%"},children:(0,b.jsx)(c.default,{src:a.image,alt:a.product_name,width:300,height:300,style:{width:"100%",height:"100%",objectFit:"cover",transition:"transform 0.3s ease"}})})}),(0,b.jsxs)("div",{className:"card-content",style:{padding:"20px 15px",display:"flex",flexDirection:"column",alignItems:"center",background:"#fff",flex:1},children:[(0,b.jsx)("h3",{style:{fontSize:"15px",lineHeight:"22px",fontWeight:700,marginBottom:"15px",textAlign:"center",textTransform:"uppercase"},children:(0,b.jsx)(d.default,{href:`/${g}/${a.subcategory}/${a.slug}`,style:{color:"#d32f2f",textDecoration:"none"},children:a.product_name})}),(0,b.jsx)("div",{className:"link-btn",style:{marginTop:"auto",paddingBottom:"5px"},children:(0,b.jsx)(d.default,{href:`/${g}/${a.subcategory}/${a.slug}`,style:{display:"inline-block",padding:"8px 20px",background:"#003b8e",color:"#fff",fontWeight:600,borderRadius:"4px",fontSize:"13px",textDecoration:"none"},children:"Read more"})})]})]})},a.slug))})}},22980,a=>{a.v(b=>Promise.all(["server/chunks/ssr/node_modules_wowjs_dist_wow_28a448ac.js"].map(b=>a.l(b))).then(()=>b(47911)))}];

//# sourceMappingURL=_fd460c55._.js.map