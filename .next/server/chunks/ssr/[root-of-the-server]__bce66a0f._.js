...
"[project]/src/utils/submitEnquiry.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function submitEnquiry(data) {
    try {
        ...
        const res = await fetch('/api/send-email', {
            ...
            body: JSON.stringify({
                ...data,
                pageUrl: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : data.pageUrl
            })
        });
        let result;
        try {
        ...
        if (res.ok && result.success) {
            return {
                success: true,
                message: result.message || 'Thank you! Your enquiry has been submitted successfully. Our team will contact you shortly.'
            };
        } else {
            return {
                success: false,
                message: result.message || 'Unable to submit your enquiry right now. Please try again or contact us directly.'
            };
        }
    } catch (error) {
...
"[project]/components/elements/DownloadProductList.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DownloadProductList() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        setStatusMessage("");
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$submitEnquiry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["submitEnquiry"])({
...
"[project]/components/elements/ContactRight.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bce66a0f._.js.map