      ...
      <div className="sortable-masonry">
        ...
        <div className="items-container row clearfix">
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 masonry-item small-column cat-1 cat-2 cat-4 cat-5">
            <div className="portfolio-block-one">
                <div className="inner-box">
                    <figure className="image-box"><Image src="/assets/images/gallery/portfolio-1.jpg" alt="Image" width={416} height={520} priority /></figure>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 masonry-item small-column at-1 cat-3 cat-5 cat-2">
            <div className="portfolio-block-one">
                <div className="inner-box">
                    <figure className="image-box"><Image src="/assets/images/gallery/portfolio-2.jpg" alt="Image" width={416} height={520} priority /></figure>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 masonry-item small-column cat-1 cat-2 cat-4 cat-5">
            <div className="portfolio-block-one">
              <div className="inner-box">
                  <figure className="image-box"><Image src="/assets/images/gallery/portfolio-7.jpg" alt="Image" width={416} height={520} priority /></figure>
                  <div className="view-btn"><Link href="assets/images/gallery/portfolio-3.jpg" className="lightbox-image" data-fancybox="gallery"><i className="icon-24"></i></Link></div>
                  <div className="text-box">
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 masonry-item small-column cat-1 cat-3 cat-5 cat-4">
            <div className="portfolio-block-one">
              <div className="inner-box">
                  <figure className="image-box"><Image src="/assets/images/gallery/portfolio-8.jpg" alt="Image" width={416} height={520} priority /></figure>
                  <div className="view-btn"><Link href="assets/images/gallery/portfolio-4.jpg" className="lightbox-image" data-fancybox="gallery"><i className="icon-24"></i></Link></div>
                  <div className="text-box">
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 masonry-item small-column cat-1 cat-2 cat-4">
            <div className="portfolio-block-one">
              <div className="inner-box">
                  <figure className="image-box"><Image src="/assets/images/gallery/portfolio-5.jpg" alt="Image" width={416} height={520} priority /></figure>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 masonry-item small-column cat-1 cat-3 cat-5 cat-2">
            <div className="portfolio-block-one">
              <div className="inner-box">
                  <figure className="image-box"><Image src="/assets/images/gallery/portfolio-6.jpg" alt="Image" width={416} height={520} priority /></figure>
