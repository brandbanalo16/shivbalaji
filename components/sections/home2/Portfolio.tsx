            ...
            <div className="auto-container">
                ...
                <div className="row clearfix">
                        ...
                        <div className="portfolio-block-one">
                            <div className="inner-box">
                                ...
                                <div className="text-box">
                                    <h3><Link href="/index-2">Regular Dental Cleaning</Link></h3>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 portfolio-block">
                        <div className="portfolio-block-one">
                            <div className="inner-box">
                                ...
                                <div className="text-box">
                                    <h3><Link href="/index-2">Prepare to Speak</Link></h3>
                                    <span>Residential</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 portfolio-block">
                        <div className="portfolio-block-one">
                            <div className="inner-box">
                                <figure className="image-box"><Image src="/assets/images/gallery/portfolio-3.jpg" alt="Image" width={480} height={600} priority /></figure>
                                ...
                                <div className="text-box">
                                    <h3><Link href="/index-2">From Diagnosis to Cure</Link></h3>
                                    <span>Residential</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 portfolio-block">
                        <div className="portfolio-block-one">
                            <div className="inner-box">
                                <figure className="image-box"><Image src="/assets/images/gallery/portfolio-4.jpg" alt="Image" width={480} height={600} priority /></figure>
                                ...
                                <div className="text-box">
                                    <h3><Link href="/index-2">Empowering Patients</Link></h3>
                                    <span>Residential</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 portfolio-block">
                        <div className="portfolio-block-one">
                            <div className="inner-box">
                                ...
                                <div className="text-box">
                                    <h3><Link href="/index-2">From Healthcare Provider</Link></h3>
                                    <span>Residential</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 portfolio-block">
                        <div className="portfolio-block-one">
                            <div className="inner-box">
                                ...
                                <div className="text-box">
                                    <h3><Link href="/index-2">Transforming Health</Link></h3>
                                    <span>Residential</span>
                                </div>
                            </div>
                        </div>
