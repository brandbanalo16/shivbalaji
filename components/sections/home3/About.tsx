                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div className="image_block_three">
                            <div className="image-box ml_3">
                                ...
                                <div className="icon-box"><Image src="/assets/images/icons/icon-14.svg" alt="Icon" width={141} height={138} priority /></div>
                                <figure className="image"><Image src="/assets/images/resource/about-1.png" alt="Image" width={627} height={601} priority /></figure>
                            </div>
                        </div>
                    </div>
                </div>
